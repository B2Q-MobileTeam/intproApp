class ApiCall{
 ...
 static String InitialImageUrl="https://api.intpro.in/mobileapi/assets/images/common/";


 static String LoginUrl= InitialUrl +"login.php";
 static String RegisterUrl = InitialUrl +"register.php";
 static String OrderDetails=InitialUrl+ "orderdetails.php";
 ...
 static String login3 =InitialImageUrl+"login3.jpg";
 static String logo1 =InitialImageUrl+"logo1.png";
 static String forgetpw =InitialImageUrl+"frgt.png";
 static String NoConnection =InitialImageUrl+"Noconnection.png";
 static String Addtocartimg =InitialImageUrl+"addtocart.png";
 static String Sharelink_pana =InitialImageUrl+"Sharelink_pana.png";
 static String successimg =InitialImageUrl+"succtwo.gif";
 static String failureimg =InitialImageUrl+"error_img.gif";
